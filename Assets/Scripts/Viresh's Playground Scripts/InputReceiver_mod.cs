...
public class InputReceiver_mod : MonoBehaviour
{
    #region Singleton

    // Singleton instance
    public static InputReceiver_mod Instance { get; private set; }
    ...
    // Instances
    private UIEffects_mod uiEffects;
    private RhythmManager rhythmManager;
    private CommandManager commandManager;
    private MovementController movementController;
    private SFXManager commandAudio;
    ...
    {
        // Instances
        uiEffects = UIEffects_mod.Instance;
        rhythmManager = RhythmManager.Instance;
        commandManager = CommandManager.Instance;
        movementController = MovementController.Instance;
        commandAudio = SFXManager.Instance;
    ...
    public void pressButton(int button, State gameState)
    {
        ...
        commandAudio.playButtonSound(button);
    }
